<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ auth()->user()->userSetting && auth()->user()->userSetting->photo !== null 
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('front.showamypost')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>My Post</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{route('front.showamycomment')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>My Comment</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="{{route('front.showinfo')}}" class="nav-link">
